    ...
    <div class="cards-geral">
      <div id="filtro-cardAnimais">
        ...
        <Button label="Submit" class="buttonCardsAnimais">
          <div class="botaoPublicar">
            <p>Publicar</p>
            <div id="icone-lupaDog">
              <img src="../assets/icons/lupadog.svg" alt="Submit Icon" class="icone-lupaDog" />
            </div>
          </div>
        </Button>
      </div>
      ...
      <div class="carousel">
        <button class="carousel__button carousel__button--left" @click="prevSlide">
          <img src="../assets/icons/arrow.png" class="arrow-left" alt="left" />
        </button>
        <div class="carousel__track-container">
          <ul class="carousel__track">
            <li v-for="(slide, index) in slides" :key="index" :class="{'current-slide': index === currentSlide}">
              <img :src="slide.image" :alt="slide.alt" class="carousel__images" />
            </li>
          </ul>
        </div>
        <button class="carousel__button carousel__button--right" @click="nextSlide">
          <img src="../assets/icons/arrow.png" alt="right" />
        </button>
        <div class="carousel__nav">
          <button v-for="(slide, index) in slides" :key="index" class="carousel__indicator" :class="{ 'current-slide': index === currentSlide }" @click="goToSlide(index)"></button>
        </div>
      </div>
      <div class="talk">
