<template>
    <section class="filtro-feedAnimais">
        <form class="form-feedAnimais">
            ...
            <div class="div-filtro-feedAnimais">
                <MultiSelect v-model="selectedCities" :options="cities" filter optionLabel="name"
                    placeholder="Raça do animal" :maxSelectedLabels="3" class="paragrafo-filtro-feedAnimais" />
            </div>
            <div class="div-filtro-feedAnimais">
